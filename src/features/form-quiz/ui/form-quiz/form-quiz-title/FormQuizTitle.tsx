...
import { quizDescriptionSelector, quizIconSelector, quizNameSelector, quizTagsSelector, quizThemeSelector } from '../../../model/selectors/form-quiz-selectors.ts'
...
export const FormQuizTitle = () => {
  ...
  const {
    ...
    updateQuizIconHandler
  } = useHandlersQuizTitle()
