...
export { incrementPage, uploadQuizzes, quizReducer, removeQuiz, updateSortQuery, resetSorting } from './model/slice/quiz-slice.ts'
...
export { quizzesSelector, errorSelector, isLoadingSelector, totalCountSelector, limitSelector, sortQuerySelector } from './model/selectors/quiz-selectors.ts'
